...
CHESSBOARD_PATH: Final = f'Assets/Images/Chessboard/{CHESSBOARD_STYLE}/'
...
PIECE_PATH: Final = f'Assets/Images/Pieces/{PIECE_STYLE}/'
...
SETTINGS_BACKGROUND: Final = 'Assets/Images/Application/background.png'
